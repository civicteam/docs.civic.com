...
<Frame className="image-50 image-rounded" caption="The user button">
  <img src="/images/auth/integration/image-1.png" />
</Frame>
...
<Info>
  We use `name` as an example here, but you can call any user object property from the user fields schema, as shown [below](/auth/integration/react#base-user-fields).
</Info>
...
| iframeMode  | No       | modal      | iframeMode=\{"embedded"}                                                                                           | Set to `embedded` if you want to embed the login iframe in your app rather than opening the iframe in a modal. See [Embedded Login Iframe section](/auth/integration/react#embedded-login-iframe) below.                                                                                                                                                                                         |
