...
<CardGroup cols={3}>
  <Card title="Express" href="/auth/integration/nodejs/express" img="/images/auth/integration/express.jpeg"/>
  <Card title="Hono" href="/auth/integration/nodejs/hono" img="/images/auth/integration/hono.jpeg"/>
  <Card title="Fastify" href="/auth/integration/nodejs/fastify" img="/images/auth/integration/fastify.jpeg"/>
</CardGroup>
...
Here are some examples of using the getUser function in popular Node.JS server environments. Note - this snippet assumes you have followed the steps to integrate login with your app as described [here](/auth/integration/nodejs).
