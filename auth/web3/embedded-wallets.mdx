...
<CardGroup cols={3}>
  <Card title="React" href="/auth/integration/react" img="/images/auth/web3/react.png"/>
  <Card title="Next.js" href="/auth/integration/next.js" img="/images/auth/web3/next.png"/>
</CardGroup>
...
<CardGroup>
  <Card title="Ethereum & EVMs" href="/auth/web3/ethereum-evm" icon="diamond" horizontal/>
  <Card title="Solana" href="/auth/web3/solana" icon="code" horizontal/>
</CardGroup>
