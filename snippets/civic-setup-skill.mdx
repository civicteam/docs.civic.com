...
- **MCP endpoint**: `https://nexus.civic.com/hub/mcp`
- **Dashboard and onboarding**: https://nexus.civic.com
...
**Authentication errors** — Token may be expired (30-day expiry). Regenerate at nexus.civic.com: go to the Install step in onboarding and generate a new token.

**No tools available** — The MCP URL may be missing a `profile` parameter. Check that `CIVIC_URL` includes `?profile=your-toolkit`. The toolkit must be configured at nexus.civic.com.
