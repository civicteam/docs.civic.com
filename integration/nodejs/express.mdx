...
const config = {
  ...
  loginSuccessUrl: 'https://your-frontend.com/', // Optional: redirect SPAs back to frontend after auth (optional)
...
| `loginSuccessUrl` | ❌ Optional | Redirect SPAs back to frontend after successful authentication |
