...
When sending the ID token from your frontend to your backend for verification, you can access it from the `userContext` object:
...
For more details, see the [FAQ: How do I verify ID tokens on my backend?](/overview/faqs#how-do-i-verify-id-tokens-on-my-backend)
</Note>
