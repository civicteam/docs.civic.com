...
Choose your preferred approach for integrating Civic Auth into your Next.js application:

<Tabs>
  <Tab title="LLM-Assisted">
    <Info>
    ...
    ```text Civic Auth Integration Prompt
...
- **Protected Routes**: [List routes that need authentication, e.g., /dashboard/*, /api/private/*]
...
- Pay attention to version requirements and security warnings in the documentation
    ...
    <Note>
      **How to use**: Copy the prompt above, fill in your project context details, and paste it into your AI assistant. The assistant will fetch the complete documentation and implement the integration for you.
    </Note>
  </Tab>
  
  <Tab title="Manual Integration">
    <Info>
      Follow the step-by-step guide below to manually integrate Civic Auth into your Next.js application.
    </Info>
    
    Continue with the [Quick Start](#quick-start) section below for detailed manual integration steps.
  </Tab>
</Tabs>
...
<Info>
  These steps apply to the [App Router](https://nextjs.org/docs/app). If you are using the Pages Router, please contact Civic at [support@civic.com](mailto:support@civic.com) for integration steps.
</Info>
