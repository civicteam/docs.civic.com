...
<Info>
  These steps apply to the [App Router](https://nextjs.org/docs/app). If you are using the Pages Router, please contact civic at support@civic.com for integration steps.
</Info>
