...
<Tabs>
  <Tab title="LLM-Assisted">
    <Info>
      Use AI assistance to automatically integrate Civic Auth into your Next.js project.
    </Info>
    
    Get started with our **[LLM-Assisted Integration Guide](/integration/nextjs-llm)** which provides a copyable prompt you can use with Claude, ChatGPT, or other AI assistants.
    
    The AI assistant will:
    - Fetch the complete documentation automatically
    - Analyze your project structure
    - Implement the integration step-by-step
    - Handle edge cases and existing auth systems
    
    **[→ Get the LLM Integration Prompt](/integration/nextjs-llm)**
  </Tab>
