...
import { useUser } from "@civic/auth/remix/useUser";
...
// Example helper function - implement according to your business logic
function isUserAdmin(email: string): boolean {
  // This is pseudo code - implement your own logic here
  // e.g., check against a list of admin emails, database lookup, etc.
