...
See the [Express integration guide](/express#frontend-integration-vanilla-javascript) for complete setup.
...
| `loginUrl`               | No       | -                                | URL to get login URLs from your backend (for backend integration)           |
