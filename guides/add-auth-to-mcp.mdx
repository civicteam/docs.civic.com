...
<Note>The full source-code for this guide is available [here](https://github.com/civicteam/mcp-auth-guide)</Note>
...
<Note>
    **What is Streamable HTTP?**<br/><br/>
    ...
    Unlike WebSockets, it's a request-response pattern. Great for tools where streaming is useful, but persistent bidirectional connections aren't needed.<br/>
</Note>
---
...
<Note>
    **Why create a new server on each request?**<br/><br/>
    ...
    Don't worry, this is not an expensive operation.<br/>
</Note>
...
<Note>
    **What is Civic Auth?**<br/><br/>
    ...
    Learn more: [civic.com/auth](https://www.civic.com/auth) | [docs.civic.com/auth](https://docs.civic.com/auth)<br/>
</Note>
---
...
- 💬 [Join the conversation on Discord](https://discord.com/invite/MWmhXauJw8)
