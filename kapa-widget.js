...
script.setAttribute("data-modal-example-questions", "How do I create and access embedded wallets after Civic Auth login?,Can users sign up with their existing wallet or use embedded wallets?,Which framework should I use and how long will integration take?,How can I use Cursor to add Civic?,How do I add Civic to Claude Code?");
