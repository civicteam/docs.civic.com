...
Once a pass has been successfully requested, the user is required to sign the transaction that submits the pass on chain. For more information please refer to the [<mark style="color:orange;">client sent transactions</mark>](advanced/client-sent-transactions.md) section.
