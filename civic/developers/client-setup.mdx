...
<Note>
**New to Civic?** Start with [Claude Desktop](/civic/quickstart/clients/claude-desktop) for the simplest setup experience, then add development tools later.
</Note>
...
<Steps>
  ...
  <Step title="Usage">
    Hub Bridge handles authentication and routes requests to your selected Civic servers
  </Step>
</Steps>
...
<Card title="Complete Cursor Setup Guide" icon="cursor-click" href="/civic/quickstart/clients/cursor">
...
<Card title="Complete VS Code Setup Guide" icon="code" href="/civic/quickstart/clients/vscode">
...
<CardGroup cols={3}>
  ...
  <Card title="Claude Code" icon="terminal" href="/civic/quickstart/clients/claude-code">
    **2 minutes** - HTTP endpoint or Hub Bridge
  </Card>
...
<Card title="Complete JetBrains Setup Guide" icon="command" href="/civic/quickstart/clients/jetbrains">
...
<Card title="Complete Windsurf Setup Guide" icon="wind" href="/civic/quickstart/clients/windsurf">
...
<Card title="Complete Goose Setup Guide" icon="terminal" href="/civic/quickstart/clients/goose">
...
**Anthropic's CLI Agent** - Command-line coding assistant with direct HTTP endpoint support.

<Card title="Complete Claude Code Setup Guide" icon="terminal" href="/civic/quickstart/clients/claude-code">
  **Direct HTTP support** - Connect via HTTP endpoint or Hub Bridge
</Card>

**Quick Summary:**
- ✅ Direct HTTP endpoint support (recommended)
- ✅ Hub Bridge alternative method available
- ✅ OAuth browser sign-in flow
- ⏱️ Setup time: 2 minutes
...
3. **Monitor usage** - Check your Civic dashboard for activity
...
4. **Share tool selections** - use same Civic server selection
