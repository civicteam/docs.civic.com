...
<AccordionGroup>
  <Accordion title="API Token" icon="key">
    **Obtaining Your API Token:**
    ...
    4. Civic will ask you for this token when you interact with Pipedrive
...
In addition to the [14 universal guardrails](/civic/concepts/guardrails), this server has **32 server-specific guardrails** across 15 operations.
