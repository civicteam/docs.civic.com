...
description: "Access comprehensive cryptocurrency data including prices, market caps, volumes, and trending coins through CoinGecko's MCP interface"
icon: "server"
---
...
In addition to the [14 universal guardrails](/civic/concepts/guardrails), this server has **11 server-specific guardrails** across 7 operations.
