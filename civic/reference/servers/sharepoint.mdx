...
<Steps>
  <Step title="Initial Authorization Attempt">
    ...
    ![Need Admin Approval Dialog](/images/ms365-setup/02-need-admin-approval.png)
  </Step>
  <Step title="Admin Grants Consent (One-Time)">
    ...
    **Access Entra ID:**
    - From Microsoft 365: Click the app launcher (grid icon) in the top-left corner of any Microsoft 365 app → Click **Admin** → From the left sidebar, click **Show All** → Under "Admin centers", select **Identity**
      ...
      ![Microsoft 365 App Launcher](/images/ms365-setup/03-m365-app-launcher.png)

      ![Admin Centers - Identity](/images/ms365-setup/04-admin-centers-identity.png)

    - From Azure Portal: Click the app launcher (grid icon) in the top-left corner → Select **Entra** from the Microsoft Cloud services

      ![Azure App Launcher](/images/ms365-setup/05-azure-app-launcher.png)
    ...
    **Configure User Consent:**
    ...
    3. Click **User consent settings**
       ...
       ![User Consent Settings](/images/ms365-setup/09-user-consent-settings.png)
    ...
    7. On the permissions screen, click **Add permissions** → Select **Microsoft Graph**
       ...
       ![Select Microsoft Graph](/images/ms365-setup/12-select-microsoft-graph.png)
  ...
  <Step title="Complete Authorization">
    ...
    ![OAuth Consent Screen - SharePoint](/images/ms365-setup/10-oauth-consent-sharepoint.png)
...
![Admin Consent Requests Toggle](/images/ms365-setup/13-admin-consent-requests-toggle.png)
</Note>
