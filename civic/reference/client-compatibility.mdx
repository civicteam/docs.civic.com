...
| **Python / Pydantic AI** | Streamable HTTP | [Setup](/civic/recipes/python-pydantic) |
| **Vercel AI SDK** | Streamable HTTP | [Setup](/civic/recipes/vercel-ai-sdk) |

## Connection Methods

**Remote URL** — paste `https://nexus.civic.com/hub/mcp` into the client's MCP settings. Fastest setup, no local software needed.
