...
|--------|----------|------------|------------|------------|-------|
| **Civic Chat** | Web | Built-in | 0 mins | 🔥 **Recommended** | [Try Now](https://nexus.civic.com) |
| **Claude Desktop** | Desktop | Remote URL | 2 mins | Available | [Setup](/civic/quickstart/clients/claude-desktop) |
| **Claude.ai** | Web | Remote URL | 2 mins | Available | [Setup](/civic/quickstart/clients/claude-web) |
...
<Card title="Try Civic Chat Now" icon="message-circle" href="https://nexus.civic.com">
...
- **🌐 Claude.ai (Web)**: Available, no installation required
- **🖥️ Claude Desktop**: Available, consistent experience across team members
