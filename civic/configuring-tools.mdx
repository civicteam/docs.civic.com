...
description: How to select and set up MCP servers on app.civic.com and in chat
icon: "cog"
---
...
1. **On app.civic.com** - Browse and select tools before connecting your AI
2. **In AI chat** - Configure tools directly in conversation after connecting

## Method 1: Web Configuration (app.civic.com)

### Browse Available Tools

Visit **app.civic.com** to see dozens of available MCP servers:

<Frame caption="Browse tools by category on app.civic.com">
  <img
    className="rounded-lg"
    src="https://placehold.co/600x350/f8fafc/475569?text=MCP+Directory+-+Dozens+of+Servers"
    alt="Civic MCP directory showing categorized tools"
  />
</Frame>

- **Development**: GitHub, GitLab, Linear, Jira
- **Communication**: Slack, Discord, Telegram
- **Productivity**: Dropbox, Notion, Airtable
...
<Steps>
  <Step title="Browse Categories">
    ...
    <Frame caption="Categories make tool discovery easy">
      <img
        className="rounded-lg"
        src="https://placehold.co/400x250/e0f2fe/0369a1?text=Tool+Categories"
        alt="Tool categories in the MCP directory"
      />
    </Frame>
  </Step>
  <Step title="Click to Add">
    Click on any tool to add it to your configuration
    <Frame caption="One-click tool selection">
      <img
        className="rounded-lg"
        src="https://placehold.co/400x250/ecfdf5/059669?text=Add+Tools"
        alt="Adding tools to your configuration"
      />
    </Frame>
  </Step>
  <Step title="Review Selection">
    See your selected tools in the sidebar before connecting
    <Frame caption="Review your tool selection">
      <img
        className="rounded-lg"
        src="https://placehold.co/400x250/fef3c7/d97706?text=Selected+Tools"
        alt="Sidebar showing selected tools"
      />
    </Frame>
  </Step>
  <Step title="Get Connection Details">
    Copy your MCP URL or Hub Bridge installation command
    <Frame caption="Get your personalized connection details">
      <img
        className="rounded-lg"
        src="https://placehold.co/400x250/fce7f3/be185d?text=Connection+URL"
        alt="Copy connection URL or install command"
      />
    </Frame>
  </Step>
</Steps>
...
After connecting your AI client to Civic, you can configure tools directly in conversation:
...
<Note>
**One-time setup**: You only need to authenticate each tool once. Civic securely manages tokens and handles refresh automatically.
</Note>
...
### For Marketing Teams
```
"Connect ActiveCampaign and Dropbox"
...
```
"Connect to our Dropbox and HubSpot for document management"
...
### Tool Won't Connect
1. Check if the service is supported on app.civic.com
...
<CardGroup cols={2}>
  <Card title="Tool Directory" icon="server" href="/civic/reference/servers">
