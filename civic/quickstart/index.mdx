---
title: Get Started
description: Three paths to go live with Civic in under 10 minutes
icon: "bolt"
---
...
<Steps>
  <Step title="Sign up">
    Go to [nexus.civic.com](https://nexus.civic.com) and create a free account. You get 10,000 credits and 14 days.
  </Step>
  ...
  <Step title="Make your first call">
    ...
    ```bash
    curl -X POST https://nexus.civic.com/hub/mcp \
...
The fastest way to start. No client configuration, no credentials file. Sign up at [nexus.civic.com](https://nexus.civic.com) and you're in your control plane.
...
<Card title="Open Civic Chat" icon="sparkles" href="https://nexus.civic.com">
