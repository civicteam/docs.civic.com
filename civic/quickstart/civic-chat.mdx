...
Civic Chat is the built-in chat interface at [nexus.civic.com](https://nexus.civic.com) that lets you:
...
<Card title="Open Civic Chat" icon="rocket" href="https://nexus.civic.com">
