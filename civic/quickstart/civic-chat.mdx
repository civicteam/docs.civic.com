---
title: Civic Chat
description: Use Civic tools directly in our built-in chat interface - no setup required
icon: "sparkles"
---
...
Civic Chat is the built-in chat interface at [app.civic.com](https://app.civic.com) that lets you:
...
<Frame caption="Civic Chat interface ready to use">
  <img
...
<Steps>
  <Step title="Sign up at app.civic.com">
    Create your free account at [app.civic.com](https://app.civic.com)
  ...
  <Step title="Connect tools conversationally">
    ...
    <Frame caption="Connecting tools through conversation">
      <img
        className="rounded-lg"
        src="/images/steps/welcome/02.png"
        alt="Tool connection in Civic Chat"
      />
    </Frame>
  </Step>
  ...
  <Step title="Authorize when prompted">
    ...
    1. Civic Chat will provide an authorization link
...
Ask Civic Chat to show your current setup:
```
...
After testing in Civic Chat, you can optionally connect external AI clients for convenience:
...
<Note>
**Civic Chat is always available** - Even if you connect external clients, you can always return to Civic Chat for testing new tools or troubleshooting.
</Note>

## Security & Privacy

<Info>
All conversations and tool interactions in Civic Chat are:
...
<Card title="Open Civic Chat" icon="rocket" href="https://app.civic.com">
...
<CardGroup cols={2}>
  <Card title="Quick Start Guide" icon="book" href="/civic/quickstart">
    Step-by-step setup instructions
  </Card>
  <Card title="Available Tools" icon="server" href="/civic/reference/servers">
