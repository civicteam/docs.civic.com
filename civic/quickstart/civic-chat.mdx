---
title: Civic Chat — Your Control Plane
description: Configure toolkits, query audit logs, and revoke access via natural language at nexus.civic.com
icon: "terminal"
---

Civic Chat at [nexus.civic.com](https://nexus.civic.com) is your control plane for AI agent security — not a general-purpose AI assistant. It is purpose-built for three tasks: configuring your Hub, querying audit logs, and revoking access.
...
<Steps>
  <Step title="Create your account">
    Visit [nexus.civic.com](https://nexus.civic.com) and sign up. Your free trial includes 10,000 credits valid for 14 days.
...
You can also revoke via the UI at nexus.civic.com → Authorizations → Revoke.
