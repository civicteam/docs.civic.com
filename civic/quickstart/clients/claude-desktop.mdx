...
description: Connect Claude Desktop to Civic in 5 minutes
icon: "desktop"
---

import OnboardingSteps from '/snippets/_onboarding-what-happens.mdx'
import HubBridgeInfo from '/snippets/_hub-bridge-what-is.mdx'
...
If you haven't already, create your account and select your tools at nexus.civic.com:

<OnboardingSteps />

<Note>
The MCP URL (`https://nexus.civic.com/hub/mcp`) is the same for every Civic user. What makes it yours is authentication — when you click **Connect** in Claude Desktop, a browser window opens to nexus.civic.com and links that session to your account and toolkit.
</Note>
  ...
  <Step title="Connect and Authenticate">
    ...
    <Frame caption="Claude Desktop connector successfully connected">
      <img
        ...
        alt="Claude Desktop showing connected Civic connector"
      />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="First-time setup">
    When you first use an MCP command, Hub Bridge opens a browser window to nexus.civic.com. Sign in to authenticate. If you haven't created a Civic account yet, you'll be walked through tool selection during sign-up.
  </Step>
</Steps>
