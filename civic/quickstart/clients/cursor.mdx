...
<Steps>
  ...
  <Step title="First-Time Authentication">
    The first time you use any MCP command, Hub Bridge downloads itself (once, ~30 seconds) and opens a browser window to app.civic.com. Sign in to link the session to your account.
