...
<Warning>
  ChatGPT's MCP integration has significant limitations. Most users will get better results using [Civic Chat](https://nexus.civic.com) or a [supported client](/civic/reference/client-compatibility).
</Warning>
...
**We recommend using [Civic Chat](https://nexus.civic.com), Claude Desktop, or another [supported client](/civic/reference/client-compatibility) for a more reliable experience.**
...
<CardGroup cols={2}>
  <Card title="Civic Chat" icon="sparkles" href="https://nexus.civic.com">
