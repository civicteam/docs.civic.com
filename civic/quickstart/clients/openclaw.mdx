...
- **Which specific MCP tools are called** — Civic authorizes servers, not individual tool calls within them
...
<Steps>
  ...
  <Step title="Add MCP servers">
    ...
    - [See all 100+ available servers](/civic/reference/servers)

    <Callout icon="info" color="blue">
      Civic authorizes at the MCP server level (e.g., "Gmail"), not individual tools within them. Use OAuth scopes and guardrails for finer control.
    </Callout>
  </Step>
