  ...
  <Tab title="UI (Recommended)">
    <Steps>
      ...
      <Step title="Add a new server">
        ...
        - **Name:** `Civic`
        - **Command:** `npx`
        - **Arguments:** `-y mcp-remote https://nexus.civic.com/hub/mcp`
      </Step>
      ...
      "servers": [
        {
          "name": "Civic",
          "command": "npx",
          "args": ["-y", "mcp-remote@latest", "https://nexus.civic.com/hub/mcp"]
        }
      ]
    }
    ```
...
<AccordionGroup>
  ...
  <Accordion title="Authentication browser window doesn't open">
    ...
    ```bash
    npx -y mcp-remote https://nexus.civic.com/hub/mcp
    ```
