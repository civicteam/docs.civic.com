...
<Steps>
  <Step title="Set up your Civic account">
    If you haven't already, complete onboarding at nexus.civic.com:
  ...
  <Step title="Authenticate with Civic">
    On the first tool call, Goose opens a browser window to nexus.civic.com. Sign in with your Civic account to authorize the session. This is a one-time OAuth flow — credentials are cached after the first login.
