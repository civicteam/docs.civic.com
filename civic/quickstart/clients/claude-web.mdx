...
<Note>
The MCP URL (`https://nexus.civic.com/hub/mcp`) is the same for every Civic user. What makes it yours is authentication — when you click **Connect** in Claude.ai, a browser window opens to nexus.civic.com and links that session to your account and toolkit.
</Note>
