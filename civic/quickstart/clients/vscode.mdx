...
<Steps>
  ...
  <Step title="Authenticate">
    On first use of any MCP tool, VS Code opens a browser window to nexus.civic.com. Sign in with your Civic account — this links the session to your account and toolkit. No token needed.
