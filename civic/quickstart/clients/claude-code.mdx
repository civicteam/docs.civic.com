...
description: Connect Anthropic's Claude Code CLI to Civic
icon: "terminal"
---
...
- A Civic account — [create one free at nexus.civic.com](https://nexus.civic.com)
...
import AuthCallout from '/snippets/_auth-method-callout.mdx'
  ...
  <Tab title="HTTP Transport (Recommended)">
    ...
    <Steps>
      ...
      <Step title="Connect and sign in">
        ...
        Select the `civic` server. A browser window opens to nexus.civic.com — sign in with your Civic account. Once complete, Claude confirms the server is `connected` and ready to use.
      </Step>
    </Steps>
  </Tab>
