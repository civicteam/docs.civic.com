...
<Note>
**Authentication**: Gemini CLI uses OAuth. The first time you run a tool call, you'll be redirected to nexus.civic.com in your browser to sign in and authorize. After that, credentials are cached and subsequent sessions don't require a browser.
</Note>
