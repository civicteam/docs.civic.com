...
description: Remote URL vs Hub Bridge - understanding how your AI connects to Civic
icon: "network-wired"
---
...
<div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'8px',padding:'20px 24px',background:'rgba(203,134,171,0.04)',borderRadius:'8px',border:'1px solid rgba(203,134,171,0.15)',margin:'16px 0',flexWrap:'wrap'}}>
  ...
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600'}}>Internet</span>
  <span style={{color:'#CB86AB',fontSize:'16px'}}>↔</span>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.25)',fontSize:'13px',fontWeight:'700',color:'#CB86AB'}}>Civic Servers</span>
  <span style={{color:'#CB86AB',fontSize:'16px'}}>↔</span>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600'}}>Your Tools</span>
</div>
...
<div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'8px',padding:'20px 24px',background:'rgba(203,134,171,0.04)',borderRadius:'8px',border:'1px solid rgba(203,134,171,0.15)',margin:'16px 0',flexWrap:'wrap'}}>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600'}}>Your AI Client</span>
  <span style={{color:'#CB86AB',fontSize:'16px'}}>↔</span>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.25)',fontSize:'13px',fontWeight:'700',color:'#CB86AB'}}>Hub Bridge (local)</span>
  <span style={{color:'#CB86AB',fontSize:'16px'}}>↔</span>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600'}}>Internet</span>
  <span style={{color:'#CB86AB',fontSize:'16px'}}>↔</span>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.25)',fontSize:'13px',fontWeight:'700',color:'#CB86AB'}}>Civic Servers</span>
