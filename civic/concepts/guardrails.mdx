...
description: Platform-configured security policies for AI agents — block PII, redact sensitive data, restrict tool access. Not a code library — configured via Civic UI or Chat
icon: "shield-halved"
---
