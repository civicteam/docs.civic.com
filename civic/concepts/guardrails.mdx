...
<div style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'8px',padding:'20px 24px',background:'rgba(203,134,171,0.04)',borderRadius:'8px',border:'1px solid rgba(203,134,171,0.15)',margin:'16px 0'}}>
  <div style={{display:'flex',alignItems:'center',gap:'8px'}}>
    <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600',whiteSpace:'nowrap'}}>Request</span>
    <span style={{color:'#CB86AB',fontSize:'16px'}}>→</span>
    <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.25)',fontSize:'13px',fontWeight:'700',color:'#CB86AB',whiteSpace:'nowrap'}}>Request Guardrails</span>
    <span style={{color:'#CB86AB',fontSize:'16px'}}>→</span>
    <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600',whiteSpace:'nowrap'}}>Tool Execution</span>
  </div>
  <span style={{color:'#CB86AB',fontSize:'20px',lineHeight:'1'}}>↓</span>
  <div style={{display:'flex',alignItems:'center',gap:'8px'}}>
    <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.25)',fontSize:'13px',fontWeight:'700',color:'#CB86AB',whiteSpace:'nowrap'}}>Response Guardrails</span>
    <span style={{color:'#CB86AB',fontSize:'16px'}}>→</span>
    <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600',whiteSpace:'nowrap'}}>Response</span>
  </div>
</div>
