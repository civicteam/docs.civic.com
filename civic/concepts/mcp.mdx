---
title: What is MCP?
description: A beginner's guide to the Model Context Protocol and why it powers Civic
icon: "circle-info"
---
...
<div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'8px',padding:'20px 24px',background:'rgba(203,134,171,0.04)',borderRadius:'8px',border:'1px solid rgba(203,134,171,0.15)',margin:'16px 0',flexWrap:'wrap'}}>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600'}}>Your AI (Client)</span>
  <span style={{color:'#CB86AB',fontSize:'16px'}}>↔</span>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.25)',fontSize:'13px',fontWeight:'700',color:'#CB86AB'}}>MCP Protocol</span>
  <span style={{color:'#CB86AB',fontSize:'16px'}}>↔</span>
  <span style={{padding:'8px 16px',borderRadius:'6px',background:'rgba(203,134,171,0.10)',fontSize:'13px',fontWeight:'600'}}>Your Tools (Servers)</span>
</div>
...
**Civic is an MCP service** - we've built the infrastructure so you don't have to:
...
Instead of setting up individual MCP servers yourself, you connect to Civic and get access to everything through one secure connection.
...
<Card title="Start with Claude Desktop" icon="rocket" href="/civic/quickstart/clients/claude-desktop">
