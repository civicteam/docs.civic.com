...
Connect a [DeepAgents](https://github.com/civicteam/deepagents-reference-implementation-civic) agent to Civic using the `langchain-mcp-adapters` package, which bridges DeepAgents' tool interface with Civic's Streamable HTTP MCP transport.
