---
title: AutoGen
description: Connect a Microsoft AutoGen agent to Civic's MCP Hub using streamable HTTP transport
icon: "robot"
---
...
<Card title="autogen-reference-implementation-civic" icon="github" href="https://github.com/titus-civic/autogen-reference-implementation-civic">
