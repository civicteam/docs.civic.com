...
<Card title="semantic-kernel-reference-implementation-civic" icon="github" href="https://github.com/titus-civic/semantic-kernel-reference-implementation-civic">
