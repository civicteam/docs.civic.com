...
description: Validate inputs with Pydantic and call Civic tools using Civic access tokens
icon: "python"
public: true
---
...
This recipe shows how to use Pydantic AI with Civic MCP tools. To call Civic, you need a Civic `access_token`.
...
# Connect to Civic MCP Hub with Bearer auth
...
# 1) Ask model, 2) If tool call requested, call Civic, 3) Send result back
```
