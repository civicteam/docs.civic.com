...
<div style={{margin: '24px 0', borderRadius: '12px', overflow: 'hidden', border: '1px solid rgba(203, 134, 171, 0.25)'}}>
  <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', padding: '16px 24px', background: 'rgba(203, 134, 171, 0.06)', borderBottom: '1px solid rgba(203, 134, 171, 0.15)'}}>
    <span style={{padding: '6px 14px', borderRadius: '6px', background: 'rgba(203, 134, 171, 0.12)', fontSize: '13px', fontWeight: '600'}}>Your AI Agent</span>
    <span style={{color: '#CB86AB', fontSize: '18px'}}>→</span>
    <span style={{padding: '6px 14px', borderRadius: '6px', background: 'rgba(203, 134, 171, 0.28)', fontSize: '13px', fontWeight: '700', color: '#CB86AB'}}>Civic Hub</span>
    <span style={{color: '#CB86AB', fontSize: '18px'}}>→</span>
    <span style={{padding: '6px 14px', borderRadius: '6px', background: 'rgba(203, 134, 171, 0.12)', fontSize: '13px', fontWeight: '600'}}>85 MCP Servers</span>
  </div>
  <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)'}}>
    <div style={{padding: '20px', borderRight: '1px solid rgba(203, 134, 171, 0.15)', textAlign: 'center'}}>
