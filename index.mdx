...
<Info>
Civic Auth supports both **PKCE** (recommended for most apps) and **client secret** authentication flows. See our [Authentication Flows guide](/overview/authentication-flows) to understand which approach fits your application architecture.
</Info>
