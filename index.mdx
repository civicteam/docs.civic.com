...
<Info>
Civic Auth supports multiple OAuth 2.0 authentication methods for maximum security. Choose **PKCE-only** for public clients, **client secrets** for traditional OAuth compatibility, or **both together** for maximum security. See our [Authentication Flows guide](/overview/authentication-flows) to understand which approach fits your application architecture.
</Info>
