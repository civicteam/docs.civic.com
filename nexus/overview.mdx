...
<Steps>
  <Step title="Sign up at nexus.civic.com">
    Create your account and browse available tools (GitHub, Slack, Google Drive, etc.)
    <Frame caption="Sign up and browse tools">
      <img
        className="rounded-lg"
        src="https://placehold.co/400x250/f0f9ff/0ea5e9?text=Browse+50%2B+Tools"
...
<CardGroup cols={3}>
  <Card title="ChatGPT" icon="message-circle" href="/nexus/quickstart/clients/chatgpt">
    **Coming Soon** • Direct connector
  </Card>
...
<Card title="Try Nexus Chat Instantly" icon="rocket" href="https://nexus.civic.com">
  **Zero setup required** - Sign up and start using 50+ tools in our built-in chat interface
</Card>
