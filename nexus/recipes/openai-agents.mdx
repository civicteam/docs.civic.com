...
<Tip>
**Prefer AI-assisted setup?** Use our [AI prompt](/nexus/ai-prompts/openai-agents) with Claude, ChatGPT, or Cursor to automatically generate this integration code for you.
</Tip>
...
<Note>
**Prerequisites:**
1. **Node.js 18+ project** (Next.js or any Node.js framework)
...
for await (const event of result) {
  if (
    ...
    console.log(event.data.event.delta);
  }
}
...
const result = await run(
  agent,
  'Delete my GitHub repository named test-repo',
  {
    humanInTheLoop: {
      getApproval: async (params) => {
        console.log(`Tool ${params.toolName} needs approval`);
        console.log(`Arguments:`, params.arguments);

        // Implement your approval logic here
        // Could show UI, send notification, etc.
...
<Card title="Use AI to Set This Up" icon="robot" href="/nexus/ai-prompts/openai-agents">
