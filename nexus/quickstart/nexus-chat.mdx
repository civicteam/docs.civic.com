...
<Frame caption="Nexus Chat interface ready to use">
  <img
    ...
    src="https://placehold.co/800x450/f3e8ff/a855f7?text=Welcome+to+Nexus+Chat%0A%0ATry%3A+%22Connect+me+to+GitHub%22%0AOr%3A+%22Show+my+Slack+messages%22"
...
<Steps>
  <Step title="Sign up at nexus.civic.com">
    ...
    <img
      className="rounded-lg"
      src="https://placehold.co/600x300/e0e7ff/6366f1?text=Create+Your+Civic+Account"
  ...
  <Step title="Connect tools conversationally">
    ...
    <Frame caption="Connecting tools through conversation">
      <img
        className="rounded-lg"
        src="https://placehold.co/600x350/d1fae5/22c55e?text=Chat%3A+%22Connect+me+to+GitHub%22%0A%E2%86%93%0AAuthorizing+GitHub...%0A%E2%9C%85+GitHub+connected!"
  ...
  <Step title="Authorize when prompted">
    ...
    <Frame caption="OAuth authorization flow">
      <img
        className="rounded-lg"
        src="https://placehold.co/600x300/fef3c7/f59e0b?text=Click+to+authorize+GitHub%0A%E2%86%93%0A%5BAuthorize+Civic+Nexus%5D"
