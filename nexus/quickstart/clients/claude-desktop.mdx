...
<Steps>
  <Step title="Open Claude Desktop settings">
    ...
    <Frame caption="Navigate to Claude Desktop Settings → Developer">
      <img
        className="rounded-lg"
        src="https://placehold.co/700x400/f0f9ff/0ea5e9?text=Claude+Desktop+Settings+%E2%86%92+Developer"
        alt="Claude Desktop settings showing Developer section"
      />
    </Frame>
  </Step>

  <Step title="Add custom connector">
    1. Look for **"MCP Connectors"** section
    2. Click **"Add custom connector"** button
    3. Enter a name: **"Civic Nexus"**
    4. Paste the MCP URL: `https://nexus.civic.com/hub/mcp`
    5. Click **"Add"** then **"Connect"**
    
    <Frame caption="Add custom MCP connector in Claude Desktop">
      <img
        className="rounded-lg"
        src="https://placehold.co/700x450/d1fae5/22c55e?text=Add+Custom+Connector%0A%E2%86%93%0AName%3A+Civic+Nexus%0AURL%3A+nexus.civic.com%2Fhub%2Fmcp"
        alt="Claude Desktop MCP connector dialog"
      />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Test your connection">
    ...
    <Frame caption="Claude Desktop successfully using connected tools">
      <img
        className="rounded-lg"
        src="https://placehold.co/700x300/f3e8ff/a855f7?text=Claude+Desktop+Chat%0A%E2%86%93%0A%22Here+are+your+recent+GitHub+PRs%3A%22%0A%E2%80%A2+Fix+login+bug+%28%23123%29%0A%E2%80%A2+Add+new+feature+%28%23124%29"
