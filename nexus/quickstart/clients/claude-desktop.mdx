...
<Steps>
  ...
  <Step title="Copy your personalized MCP URL">
    After selecting servers, you'll see your personalized MCP URL. It will look like:
    ```
    https://nexus.civic.com/hub/mcp/<your-unique-id>
    ```
...
<Steps>
  ...
  <Step title="Add custom connector">
    ...
    4. Paste your personalized MCP URL from nexus.civic.com
...
## Reset or Remove Connector

If you need to reconfigure or remove the Civic Nexus connector:

<Steps>
  <Step title="Access connector settings">
    Go to Claude Desktop Settings → Developer → MCP Connectors
  </Step>
  <Step title="Remove connector">
    Find "Civic Nexus" in your connectors list and click the remove/delete button
  </Step>
  <Step title="Re-add if needed">
    Follow the setup steps above to re-add with a fresh MCP URL from nexus.civic.com
  </Step>
</Steps>
