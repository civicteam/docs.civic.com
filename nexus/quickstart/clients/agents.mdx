...
You can pre-load [skills](/nexus/concepts/toolkits#toolkit-descriptions) into an agent session using the `skills` query parameter. Skills are reusable AI capabilities that encode business knowledge and workflows.
