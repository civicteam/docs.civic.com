...
<Steps>
  ...
  <Step title="Select your tools">
    Browse and select the MCP servers you want to connect (GitHub, Slack, Google Drive, etc.)
  </Step>
...
<Steps>
  ...
  <Step title="Add Custom Connector">
    ...
    <Frame caption="Adding a custom MCP connector in Claude.ai">
      <img
        ...
        src="https://placehold.co/700x450/f0f9ff/0ea5e9?text=Add+Custom+Connector%0A%E2%86%93%0AName%3A+Civic+Nexus%0AServer+URL%3A+nexus.civic.com%2Fhub%2Fmcp%0A%5BAdd%5D"
  ...
  <Step title="Connect and Authenticate">
    ...
    <Frame caption="Claude.ai connector successfully connected">
      <img
        className="rounded-lg"
        src="https://placehold.co/600x300/d1fae5/22c55e?text=Connectors%0A%E2%86%93%0ACivic+Nexus+%E2%9C%85+Connected%0A%5BManage%5D+%5BDisconnect%5D"
