...
<Steps>
  ...
  <Step title="Copy your MCP URL">
    Your personalized MCP URL will be displayed: `https://nexus.civic.com/hub/mcp`
    
    <Warning>
      **Keep this URL private** - it's linked to your account and services.
    </Warning>
  </Step>
</Steps>
  ...
  <Step title="Add Custom Connector">
    ...
    <Frame caption="Adding a custom MCP connector in Claude.ai">
      <img
        ...
        src="https://placehold.co/600x400/f0f9ff/0ea5e9?text=Claude.ai+Add+Connector"
        alt="Claude.ai connector settings interface"
      />
    </Frame>
  </Step>
