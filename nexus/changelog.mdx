...
<Update label="January 22, 2026" description="v0.1.79">

**Features**
- Improved app organization with redesigned grouping interface
- Enhanced connection status display with live indicators
- Added user analytics for better product insights

**Improvements**
- Simplified navigation with automatic redirection to main interface
- Updated authentication experience with latest improvements

**Bug fixes**
- Fixed issues with chat interface during task execution
- Resolved multiple loading indicators appearing simultaneously
- Improved error handling for large responses
- Fixed display issues with tool numbering in grouped operations

</Update>

<Update label="December 15, 2025" description="v0.1.78">

**Features**
- Test feature from December
