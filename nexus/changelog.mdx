...
**Bug fixes**
- Fixed an issue where switching profiles quickly could load the wrong context
- Fixed certain tools within skills not appearing in the available tools list
- Chat requests now correctly include the user's timezone
