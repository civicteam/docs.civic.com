...
<Update label="January 23, 2026" description="v0.1.79">

**Features**
- Improved app organization with redesigned grouping interface
- Enhanced connection status indicators with redesigned live badges
- Email addresses now tracked in user analytics profiles
- Added analytics for first-time user interactions

**Improvements**
- Updated authentication system with latest improvements
- Root path now redirects to main web interface

**Bug fixes**
- Fixed chat component issues during task execution
- Resolved multiple typing indicators appearing simultaneously
- Improved error handling for large tool responses
- Fixed numbering issues in tool groups and footnotes
