...
<Tip>
**Deploying an agent?** If you're connecting an autonomous agent or automation platform, see the [Installing into an agent](/nexus/quickstart/clients/agents) guide for profile locking, skills, and other agent-specific configuration.
</Tip>
