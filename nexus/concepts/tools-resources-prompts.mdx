...
- **Google Drive**: Create a document, share a file, move files to folders
...
- **Google Drive**: File contents, folder structures, file metadata
...
### Google Drive Server
- **Tools**: Create/edit documents, share files, organize folders
