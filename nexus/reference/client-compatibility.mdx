...
**How it works:** Copy your personalized MCP URL from [nexus.civic.com](https://nexus.civic.com) and paste it into your client's settings.
...
<CardGroup cols={3}>
  ...
  <Card title="Browse Available Tools" icon="server" href="/nexus/reference/servers">
    See all 50+ tools and services you can connect
  </Card>
...
<Steps>
  <Step title="Select Your Tools">
    Visit **[nexus.civic.com](https://nexus.civic.com)** to browse and select from 50+ available tools
  </Step>
  ...
  <Step title="Add More Tools">
    Use chat commands: `"Connect me to Slack"` or `"Add Google Drive to my tools"`
  </Step>
