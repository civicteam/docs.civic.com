...
<Note>Tool counts are approximate and may change as servers evolve.</Note>

<CardGroup cols={2}>
  <Card title="ActiveCampaign" icon="envelope" href="/nexus/reference/servers/activecampaign">
    **~37 tools** for marketing automation, email campaigns, contact management, and CRM workflows
  </Card>
  <Card title="GitHub" icon="github" href="/nexus/reference/servers/github">
    **~38 tools** for repository management, issue tracking, pull requests, and development workflows
  </Card>
  <Card title="Slack" icon="slack" href="/nexus/reference/servers/slack">
    **~8 tools** for team communication, channel management, messaging, and workspace collaboration
  </Card>
  <Card title="Notion" icon="notion" href="/nexus/reference/servers/notion">
    **~18 tools** for database operations, page management, content creation, and knowledge management
  </Card>
  <Card title="Google Drive" icon="google-drive" href="/nexus/reference/servers/googledrive">
    **~4 tools** for file management, content access, search, and document operations
  </Card>
</CardGroup>

### Coming Soon (33+ Additional Servers)
