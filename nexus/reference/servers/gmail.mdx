---
title: Google Gmail
description: Access and manage Gmail messages, labels, threads, and attachments
icon: "server"
---

## Overview

The Google Gmail server enables AI assistants to interact with [Gmail](https://mail.google.com), providing comprehensive email management including message search, sending, labeling, thread management, and attachment handling through the Gmail API.
...
<CardGroup cols={2}>
  ...
  <Card title="Attachment Handling" icon="paperclip">
    List and download email attachments programmatically
  </Card>
</CardGroup>
...
<AccordionGroup>
  <Accordion title="list_gmail_attachments">
    List all attachments in a message with IDs, filenames, and sizes.
  </Accordion>

  <Accordion title="download_gmail_attachment">
    Download attachment content as base64-encoded data with metadata.
  </Accordion>
</AccordionGroup>
...
"List all attachments in the latest email and download the PDF" - Handle email attachments programmatically.
