...
<Steps>
  ...
  <Step title="Connect to Nexus">
    1. Add the Microsoft 365 Mail server to your Nexus environment
    2. Authorize using OAuth when prompted with your Microsoft account
  </Step>
  <Step title="Test Connection">
    Start with a simple command like "Show me my latest 5 emails" to verify the connection works properly.
  </Step>
</Steps>
