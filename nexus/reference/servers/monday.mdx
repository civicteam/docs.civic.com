...
- **Transport**: SSE (Server-Sent Events) - Remote MCP server

<Note>
The Monday.com server uses Server-Sent Events (SSE) for real-time communication with the Monday.com API.
</Note>
