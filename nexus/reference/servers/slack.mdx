...
<Steps>
  ...
  <Step title="Invite Bot to Channels">
    **Important:** Before your bot can read or send messages in a channel, you must invite it to that channel.
    
    1. Open the Slack channel where you want the bot to work
    2. Click on the channel name at the top to open channel details
    ...
    <Warning>
      Your bot will only have access to channels it has been invited to. If you try to read messages or post to a channel where the bot hasn't been invited, you'll receive an error.
    </Warning>
  </Step>
