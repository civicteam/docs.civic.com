...
<Note>
**Guardrails are now a core Civic feature!** For the complete documentation on using guardrails, see [Guardrails in Civic](/civic/concepts/guardrails).
</Note>
...
See the [Guardrails documentation](/civic/concepts/guardrails) in Civic.
