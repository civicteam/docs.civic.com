...
description: Solutions for common Civic setup and connection issues
...
<AccordionGroup>
  <Accordion title="401 Unauthorized - ChatGPT/Claude Connector" icon="key">
    ...
    **For Claude Desktop/Claude.ai:**
    ...
    - Verify the MCP URL is correct: `https://app.civic.com/hub/mcp`
  ...
  <Accordion title="401 During Tool Usage" icon="exclamation-triangle">
    ...
    **Solutions:**
    - Visit [app.civic.com](https://app.civic.com) and ensure you've authorized the specific services (GitHub, Slack, etc.)
...
<AccordionGroup>
  <Accordion title="404 Connector Not Found" icon="link-slash">
    ...
    **Solutions:**
    - Double-check the MCP URL is exactly: `https://app.civic.com/hub/mcp`
    - Ensure you have created an account at [app.civic.com](https://app.civic.com)
...
<AccordionGroup>
  ...
  <Accordion title="Tools not working or unavailable" icon="tools">
    ...
    **Solutions:**
    1. **Check connector status:** In Claude Desktop settings, verify Civic connector shows "Connected"
...
For information on managing organizations, inviting members, switching between organizations, or converting a personal account to an organization, see the [Managing Your Organizations](/civic/organizations) page.
