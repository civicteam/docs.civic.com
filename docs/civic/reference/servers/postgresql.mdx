...
description: >-
  Connect to PostgreSQL databases with advanced security features, query
  optimization, and database health monitoring. Supports both restricted
  (read-only with SQL validation) and unrestricted modes.
---
