...
title: Box
description: >-
  Securely connect AI agents to your enterprise content in Box. Access files,
  folders, collaborate, search, and use Box AI for intelligent document queries.
  Official Box MCP server.
