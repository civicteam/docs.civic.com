...
title: Salesforce
description: >-
  Connect and interact with Salesforce CRM through Model Context Protocol,
  enabling object management, data queries, Apex code operations, and
  comprehensive field-level security control
---
