...
description: >-
  Copy-paste prompt for AI assistants to connect your agent to Civic — works
  with Anthropic SDK, OpenAI Agents, LangChain, Pydantic AI, Vercel AI SDK, and
  more
---
...
<Tabs>
  ...
  <Tab label="Incorrect — Regenerate">
    ```python
