...
<Tip>
**Looking for pilot engagements or enterprise pricing?** Civic ships forward deployed agents for mid-market businesses — pilots start at $15K. [Book a discovery call](https://civic.com) or email [bd@civic.com](mailto:bd@civic.com).
</Tip>

## Platform Credit Plans
...
<CardGroup cols={3}>
  <Card icon="flask" title="Builder">
    **\$25/month**

    **30,000** credits per month

    - Connect to 95+ MCP servers
    - Top up credits as needed:
    - \$10 / 15,000 credits
    - \$50 / 100,000 credits

    [Get Started](https://app.civic.com)
  </Card>
  <Card icon="rocket" title="Pro">
    **\$99/month**
...
<CardGroup cols={2}>
  <Card icon="comments" title="Civic Chat">
    Workflows executed interactively in the Civic interface. Includes full reasoning and orchestration cost.
  ...
  <Card icon="code" title="Your Own Tooling">
    Workflows triggered from your chatbot, IDE, or SDK. Credits measure only Civic orchestration—not your LLM costs.
...
<Note>
**Civic Chat consumes credits.** All Civic Chat interactions — including Configurator Agent (setting up toolkits and guardrails), Audit Agent (querying logs), and Revocation Agent commands — draw from the same credit pool as tool calls made by your agents.
</Note>
...
| Configurator Agent command (e.g. "Add a guardrail to block delete_event") | ~50-150 |
...
2. Click **["Billing"](https://app.civic.com/web/settings/billing)** in your account menu
3. Select **"Upgrade to Pro Plan"**
4. Complete the secure checkout with Stripe

### Purchasing Credit Top-Ups

1. Go to your **[Billing](https://app.civic.com/web/settings/billing)** page
...
Go to **[Billing](https://app.civic.com/web/settings/billing)** \> **"Manage Billing"** in the Stripe portal. Your access continues until the end of your paid period.
...
<AccordionGroup>
  <Accordion title="What happens if I run out of credits?">
    ...
    **Max Plan:**\
    If you need more credits than the amounts available on a Max plan, please contact [bd@civic.com](mailto:bd@civic.com) to discuss your custom options.

    Need help upgrading or purchasing top-ups? Check out the Managing Your Subscription section above for step-by-step instructions.

    Want to track your credit usage? Click your profile picture in the bottom left corner, then go to [Settings \> Activity](https://app.civic.com/web/settings/activity).
  </Accordion>
  ...
  <Accordion title="How do I change or remove my payment method?">
    ...
    1. Go to [app.civic.com](https://app.civic.com)
    2. Click on your account name in the bottom left corner
    3. Go to **[Settings \> Billing](https://app.civic.com/web/settings/billing)**
  ...
  <Accordion title="How do I access my invoices and billing history?">
  ...
  <Accordion title="How do I track my credit consumption?">
    To see your current credit usage:

    1. Go to [app.civic.com](https://app.civic.com)
    2. Click on your profile picture in the bottom left corner
    3. Go to **[Settings \> Activity](https://app.civic.com/web/settings/activity)**
  ...
  <Accordion title="My payment method failed. What should I do?">
    If your Civic payment fails, the system will automatically retry the charge. Your account may be temporarily paused but will be reactivated as soon as a payment succeeds.
    ...
    **Steps to resolve:**
    ...
    1. Go to **[Billing](https://app.civic.com/web/settings/billing)** in your account menu
    ...
    If the issue persists, please reach out to our support team via:
    ...
    1. Your account ID (found in your URL: https://app.civic.com/web/accounts/\*\*your-account-id\*\*)
