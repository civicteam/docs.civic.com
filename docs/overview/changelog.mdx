...
<Update label="June 15, 2026" description="apps-0.2.101">

**Features**
- Added authentication support for MCP (Model Context Protocol) clients, enabling MCP-based applications to integrate with Civic Auth with proper branding and scope configuration
