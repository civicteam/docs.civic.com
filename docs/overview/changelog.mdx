...
**Features**
- Added login support for MCP clients using Client ID Metadata Documents, enabling proper branding and scope configuration for dynamically registered applications
