...
**Features**
- Dynamic client registration now supports a configuration option to allow sub-clients (such as development tools) to use localhost redirect URIs without requiring them in the parent application's domain list
