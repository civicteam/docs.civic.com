...
<Update label="June 22, 2026" description="auth-server-1.2.35">

**Bug fixes**
- Fixed an issue where some OAuth clients connecting without an explicit scope parameter were incorrectly denied access
