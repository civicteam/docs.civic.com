...
| -------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------ |
| **Cost**                   | \$0                                                           | \$25 per month                                                           |
| **MAU**                    | 2,000 users with embedded wallets included per month          | \$0.025 per additional wallet user (first 2,000 wallet users are free\!) |
| **SSO Options**            | Multiple SSO options                                          | Included                                                                 |
| **Customizable Login UI**  | Drag & drop customization for seamless branding               | Included                                                                 |
| **Integration Speed**      | Lightning-fast: Get up and running in minutes                 | Included                                                                 |
| **Scalability**            | Secure, reliable, and built for modern applications           | Included                                                                 |
...
<Info>
  **How MAU counting works for Web3 apps:** The 2,000 MAU limit applies only to users who have an embedded wallet provisioned. Users who log in to your app _without_ a wallet are counted against the standard **Auth Only limit of 15,000 MAU** — not the wallet limit.

  Once your wallet-user count exceeds 2,000, you will be charged $0.025 per additional wallet user. Non-wallet users can continue to authenticate normally up to the 15,000 MAU limit.
</Info>
