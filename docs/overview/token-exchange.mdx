...
description: >-
  Exchange tokens from Civic Auth or external identity providers for Civic
  access tokens using OAuth 2.0 Token Exchange (RFC 8693).
---
...
<Tabs>
  <Tab label="Civic Token Exchange">
  ...
  <Tab label="Federated Token Exchange">
