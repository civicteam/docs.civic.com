...
title: FastAPI
description: >-
  Follow the steps to set up Civic Auth with a
  [FastAPI](https://fastapi.tiangolo.com/) backend (a working example is
  available in the [github
  repo](https://github.com/civicteam/civic-auth-py/tree/main/examples/fastapi)).
