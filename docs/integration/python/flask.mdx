...
title: Flask
description: >-
  Follow these simple steps to set up Civic Auth with a
  [Flask](https://flask.palletsprojects.com/) backend (a working example is
  available in the [github
  repo](https://github.com/civicteam/civic-auth-py/tree/main/examples/flask)).
---

import PythonSdkWarning from '@site/docs/_snippets/_python-sdk-warning.mdx';
