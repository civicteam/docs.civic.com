...
If you prefer to integrate manually or need more control over the process, check out our [Integration guides](/integration/react) for step-by-step instructions. 
