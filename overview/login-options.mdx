...
You can customize the passkey prompt frequency by setting "Ask user to register a passkey every" to either:
- A specific number of logins (e.g., every login, every 5 logins)
- Time-based intervals (e.g., every week, every month)
