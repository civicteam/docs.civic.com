...
We've been busy with our bug spray! Fixed those pesky login app loading issues during redirects, resolved mobile logo pixelation (crisp logos for everyone!), and made Apple authentication much more graceful when users decide to cancel.
...
Fixed errors that occurred when setting up production applications. We've smoothed out the process so your launch day goes exactly as planned.
