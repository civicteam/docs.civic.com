...
Your enterprise customers have been asking for it, and we delivered! Client secret authentication is now fully supported for confidential client applications. This brings the enhanced security that large organizations need when integrating Civic Auth into their mission-critical systems.
...
👥 **No more twin accounts**
Fixed that annoying bug where the Customer Dashboard occasionally got excited and created duplicate accounts. One user, one account - as it should be.
