...
**Features**
- Added an account discovery API that lets you programmatically list your accounts, including account IDs, app IDs, and account names
...
**Improvements**
- Deep-link targets are now preserved through the full login and account creation flow, so you land on the right page after signing in
- Resolved several dependency vulnerabilities to keep your environment secure

**Security**
- Added validation to prevent open-redirect attacks when using deep links
