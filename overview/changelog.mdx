...
- Support for [React Native](https://docs.civic.com/auth/integration/mobile/react-native) and [Vanilla JavaScript](https://docs.civic.com/auth/integration/vanillajs).
