...
🐛 **Bug hunting season**
We've been busy fixing:
- Login redirects work properly again
- Mobile logos are crisp instead of pixelated 
- Apple login handles cancellations without breaking
- Fixed some edge cases when no auth methods are configured
