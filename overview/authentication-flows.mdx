...
<Tabs>
  ...
  <Tab title="Client Secret Only">
    **Best for:** Server-side applications that do not support PKCE.
    ...
    const config = {
      clientId: "your_client_id",
      clientSecret: "your_client_secret", // Contact Civic for this
...
<Info>
If you need a client secret, contact [support@civic.com](mailto:support@civic.com).
</Info>
...
| `clientSecret` | Not used | Required | Required | Contact support to get a client secret. |
