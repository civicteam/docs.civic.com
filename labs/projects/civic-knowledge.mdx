...
description: An internal AI assistant for querying logs, tickets, dashboards, and more
---
...
- Logs and diagnostics (Loggly)
- BI dashboards and databases (Redshift)
- Ticketing systems (Jira)
- Internal wikis and docs
- Source code & repositories (GitHub)
- Civic Pass verification services
...
- [GitHub Repository](https://github.com/civicteam/civic-kb-chatbot) (private)
