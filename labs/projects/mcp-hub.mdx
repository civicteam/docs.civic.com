...
<AccordionGroup>
  <Accordion title="I want to integrate with a local AI agent, such as Claude Desktop">
    Connect your desktop AI assistant to cloud-hosted MCP servers using our Hub Bridge:
    
    1. Install the hub-bridge package
...
<Tabs>
    ...
    2. Configure your AI assistant to use the bridge
