...
Monetize existing API-key-protected MCP servers:
...
We advise you deploy your own instance to ensure stablity. The demo server source code is available in the [x402-mcp repository](https://github.com/civicteam/x402-mcp/blob/main/example/server.ts)

## Network Configuration

Supported networks from viem:
