---
title: "ICP Civic Credential Check Button"
icon: "key"
description: "The ICP Civic Credential Check Button is a React component that provides a streamlined interface for checking and obtaining Civic Pass credentials on the Internet Computer Protocol (ICP) network."
---
...
|`config`|`Partial<Config>`|Configuration options|
