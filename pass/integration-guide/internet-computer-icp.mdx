...
icon: circle-info
description: "This guide explains how to integrate Civic Pass verification into your Internet Computer Protocol (ICP) application using the Civic Pass canister and React component."
---
...
* Access to an Internet Computer application ([Guide to creating an IC application](https://internetcomputer.org/docs/building-apps/getting-started/quickstart))
...
<Steps>
  <Step title="Create a test application using the provided code"/>
  <Step title="Visit the demo site to test the complete verification flow"/>
  <Step title="Implement backend verification using the DFX SDK"/>
  <Step title="Test credential validation in both frontend and backend"/>
  <Step title="Verify error handling and edge cases"/>
</Steps>
