---
title: "Country Blocking Based on Residence/Nationality"
icon: earth-asia
---
...
2. **Tokenized Compliance:** Once verified, Civic issues a blockchain-based attestation ([Civic ID Verification Pass](/pass/introduction/overview-of-civic-pass)) certifying the user’s eligibility based on their verified residence or nationality.
