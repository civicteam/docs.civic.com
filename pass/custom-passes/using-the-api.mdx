...
The Civic Pass API is a RESTful API that allows [Custom Pass](/pass/custom-passes/issue-your-own-custom-pass) holders to manage their passes programmatically from their backends.
...
For full API documentation, see the [OpenAPI Docs](/api-reference/introduction).
