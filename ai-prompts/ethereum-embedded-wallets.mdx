---
title: "Ethereum Embedded Wallets"
icon: "ethereum"
public: true
---
...
3. The assistant will ask for your project details and guide you through adding Ethereum wallet functionality
4. The assistant will fetch the complete Ethereum documentation and implement the integration
...
<Note>
  **Need help?** If you encounter any issues during the LLM-assisted integration, you can always fall back to the [manual Ethereum integration guide](/web3/ethereum-evm).
</Note>
...
4. **Install required dependencies** for Ethereum Web3 functionality
5. **Configure Wagmi** with Civic's embedded wallet connector
6. **Enhance your auth provider** with Web3 capabilities
7. **Implement wallet creation** for new users
8. **Add wallet components** for balance checking and transactions
9. **Configure multi-chain support** if requested
10. **Set up chain switching** functionality
11. **Handle framework-specific configurations**
...
The embedded wallet works with any EVM-compatible network:
