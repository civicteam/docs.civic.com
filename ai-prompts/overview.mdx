...
Use AI assistants like Claude, Cursor, or other LLMs to automatically integrate Civic into your project. These prompts provide step-by-step instructions that AI assistants can follow.

## Civic Hub — Agent Security

Connect your AI agent to Civic Hub for guardrails, audit logging, and access to 85 MCP servers. No custom security code needed — just an MCP connection.

<CardGroup cols={1}>
  <Card title="Civic Hub (Agent Security)" href="/ai-prompts/civic-hub" icon="shield-check">
    AI prompt for connecting any agent framework to Civic Hub — works with Anthropic SDK, OpenAI Agents, LangChain, Pydantic AI, Vercel AI SDK, and more
  </Card>
</CardGroup>

## Civic Auth — User Authentication

Add user authentication to your web application.
